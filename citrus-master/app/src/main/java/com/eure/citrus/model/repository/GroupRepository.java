...
public class GroupRepository {
    ...
    public static void createDefaultGroups(@NonNull Realm realm) {
        ...
        workGroup.setCategoryName(GroupHelper.INTORDUCTION);
        ...
        travelGroup.setCategoryName(GroupHelper.INTORDUCTION);
        ...
        foodGroup.setCategoryName(GroupHelper.INTORDUCTION);
        ...
        privateGroup.setCategoryName(GroupHelper.INTORDUCTION);
